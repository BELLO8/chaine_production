...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Piece> cartonTete = new ArrayList<>();
        List<Piece> cartonJupe = new ArrayList<>();
        List<Piece> cartonAxe = new ArrayList<>();
        ...
        while (piston.size() < 100) {
            ...
            //en suit on faire triage des pieces et une vérification de l'etat des machines
